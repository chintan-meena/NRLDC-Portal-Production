 ...
 * be widened later.
 */
export const FILING_TYPES_BY_CATEGORY = {
  ISGS: [
    'Violation due to SCUC',
    'Violation due to SCED',
    'Violation due to Shortfall',
 ...
 * Falls back to the full list for any category not in the map, so an unexpected
 * value never leaves the filer with no options.
 */
export function filingTypesFor(energyCategory) {
